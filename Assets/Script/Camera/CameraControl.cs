...
public class CameraControl : MonoBehaviour
{
    ...
    void FollowTarget()
    {
        ...
        if (Room.ActiveRoom?.roomBounds != null) moveTo = ClampInRect(moveTo, GetCamClampRect(), Room.ActiveRoom.cameraPaddingMin, Room.ActiveRoom.cameraPaddingMax);
    ...
    Vector2 ClampInRect(Vector2 p, Rect r, Vector2 padding_min, Vector2 padding_max)
    { return new Vector2(Mathf.Clamp(p.x, r.xMin + padding_min.x, r.xMax - padding_max.x), Mathf.Clamp(p.y, r.yMin + padding_min.y, r.yMax - padding_max.y)); }
